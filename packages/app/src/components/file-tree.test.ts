...
beforeAll(async () => {
  ...
  mock.module("@opencora/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@opencora/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@opencora/ui/icon", () => ({ Icon: () => null }))
  mock.module("@opencora/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
