...
import { compile, emitEffectImported, emitPromise, write } from "@opencora/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@opencora/protocol/groups/event"',
            },
          },
        }),
