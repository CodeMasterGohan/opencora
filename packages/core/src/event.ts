...
import type { Data, Definition, Payload } from "@opencora/schema/event"
...
import { Durable } from "@opencora/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@opencora/schema/event").ID
export type { Data, Definition, Payload } from "@opencora/schema/event"
