...
import { PluginHost } from "@opencora/core/plugin/host"
import { OpencodePlugin } from "@opencora/core/plugin/provider/opencode"
...
describe("OpencodePlugin", () => {
      ...
      expect((yield* (yield* Integration.Service).get(Integration.ID.make("opencode")))?.methods).toEqual([
        {
          ...
          type: "oauth",
          label: "OpenCora Console account",
        },
  ...
  it.live("loads providers and models from the connected OpenCora server", () =>
