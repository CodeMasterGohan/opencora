...
import { ProviderPlugins } from "@opencora/core/plugin/provider"
import { ZenmuxPlugin } from "@opencora/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://opencora.internal/", "X-Title": "opencode" })
