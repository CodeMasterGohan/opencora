import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@opencora/sdk/v2"
import { SessionTurn } from "@opencora/session-ui/session-turn"
import { SessionReview } from "@opencora/session-ui/session-review"
import { DataProvider } from "@opencora/session-ui/context"
import { FileComponentProvider } from "@opencora/ui/context/file"
import { WorkerPoolProvider } from "@opencora/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@opencora/ui/logo"
import { IconButton } from "@opencora/ui/icon-button"
import { ProviderIcon } from "@opencora/ui/provider-icon"
import { iife } from "@opencora/core/util/iife"
import { Binary } from "@opencora/core/util/binary"
import { NamedError } from "@opencora/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@opencora/ui/tabs"
import { MessageNav } from "@opencora/session-ui/message-nav"
import { FileSSR } from "@opencora/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@opencora/session-ui/pierre/worker").then((m) => ({
