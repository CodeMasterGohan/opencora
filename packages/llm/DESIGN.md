...
> current private `@opencora/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@opencora/ai`
...
import { LLM } from "@opencora/ai"
import { OpenAI } from "@opencora/ai/providers/openai"
...
```ts
import { Message } from "@opencora/ai"
...
import { LLM, Tool } from "@opencora/ai"
...
```ts
import { LLM } from "@opencora/ai/promise"
import { OpenAI } from "@opencora/ai/providers/openai"
...
```ts
import { LLMSchema } from "@opencora/ai/schema"
...
```ts
import { Provider, Protocol } from "@opencora/ai/provider"
...
@opencora/ai/provider
  experimental Provider and Protocol authoring APIs

@opencora/ai/providers/openai
@opencora/ai/providers/anthropic
@opencora/ai/providers/google
...
```
