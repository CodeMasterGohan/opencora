...
import type { AssistantMessage, Message, OpencodeClient, SessionMessageResponse } from "@opencora/sdk/v2"
...
function fromUnknownError(error: unknown, service?: string): Error {
  ...
  return new ACPError.ServiceFailureError({ safeMessage: "OpenCora service failure", service })
}
