...
import { normalizePromptContent } from "@opencora/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@opencora/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close OpenCora" } satisfies SlashOption,
    ]
