...
import { makeRuntime } from "@opencora/core/effect/runtime"
import semver from "semver"
import { InstallationChannel, InstallationVersion } from "@opencora/core/installation/version"
import { NpmConfig } from "@opencora/core/npm-config"
import { InstallationEvent } from "@opencora/schema/installation-event"
  ...
  Effect.gen(function* () {
    ...
    const upgradeCurl = Effect.fnUntraced(
      function* (target: string) {
        const response = yield* httpOk.execute(HttpClientRequest.get("https://opencora.internal/install"))
