import type { Hooks, PluginInput } from "@opencora/plugin"
import type { Model } from "@opencora/sdk/v2"
import { InstallationVersion } from "@opencora/core/installation/version"
import { OauthCallbackPage } from "@opencora/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. OpenCora will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
