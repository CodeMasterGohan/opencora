import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@opencora/llm"
...
// Move this extraction into @opencora/llm when Copilot is handled by the native runtime.
