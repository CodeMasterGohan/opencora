...
import { SessionMessageTable } from "@opencora/core/session/sql"
...
import { Shell } from "@opencora/core/shell"
import { Snapshot } from "../../src/snapshot"
import { ToolRegistry } from "@/tool/registry"
import { Truncate } from "@/tool/truncate"
import { CrossSpawnSpawner } from "@opencora/core/cross-spawn-spawner"
...
import { LocationServiceMap, locationServiceMapLayer } from "@opencora/core/location-services"
...
const writeConfig = Effect.fn("test.writeConfig")(function* (dir: string, config: Partial<ConfigV1.Info>) {
  yield* writeText(
    ...
    JSON.stringify({ $schema: "config.json", ...config }),
  )
})
