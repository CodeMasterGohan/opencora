...
- Effect plugins import `@opencora/plugin/v2/effect`, not `@opencora/core`.
- Public domain values use generated `@opencora/sdk` types.
...
- Define `PluginHost` domain capabilities in `@opencora/plugin/v2/effect`.
