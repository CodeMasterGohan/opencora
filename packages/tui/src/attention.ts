...
} from "@opencora/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@opencora/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@opencora/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@opencora/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@opencora/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@opencora/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@opencora/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "opencora"
const DEFAULT_PACK_ID = "opencora.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "OpenCora Default",
  builtin: true,
  sounds: {
